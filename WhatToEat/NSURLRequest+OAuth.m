...
static NSString * const kConsumerKey       = @"RzursxgtfH9_GhDcRZQG0g";
static NSString * const kConsumerSecret    = @"hLdIXEju7NsGeZmkoPwoEJXlzOs";
static NSString * const kToken             = @"JQJH1XdEe8Pb25a49COgCDzS7rpxi4l4";
static NSString * const kTokenSecret       = @"Kp84PMPzBcVR9AExJ7eXHujh-ak";
